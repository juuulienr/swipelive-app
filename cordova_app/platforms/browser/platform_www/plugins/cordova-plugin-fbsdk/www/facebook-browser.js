cordova.define("cordova-plugin-fbsdk.FacebookConnectPluginBrowser", function(require, exports, module) { /* globals */
...
if (window.location.protocol === "file:") {
  ...
  window.fbAsyncInit = function() {
    FB.init({
      appId      : '936988141017522',  // populated by the cordova after_prepare hook
      xfbml      : true,
      version    : 'null' // populated by the cordova after_prepare hook
    });
