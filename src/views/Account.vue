    ...
    <div class="checkout__body">
      <div v-if="user" class="top-author--container" style="padding: 0px; align-items: center;">
        <div @click="goEditProfile()" class="top-author--item">
          ...
          <img :src="require(`@/assets/img/cog.svg`)" style="width: 27px; padding: 3px; height: 27px; border: 1px solid rgb(221, 221, 221) !important; margin-left: -30px; margin-top: 40px; background: white;"/>
