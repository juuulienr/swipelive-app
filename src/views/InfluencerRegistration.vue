<template>
  <main style="padding: 0px 15px 15px;">
    <div class="checkout__header" style="padding: 5px 5px 40px 5px;">
      ...
      <div v-if="step1" class="checkout__title">Inscription Influenceur</div>
      <div v-else class="checkout__title">Réseaux Sociaux</div>
    </div>
    <div style="margin-bottom: 30px;">
      ...
      <div v-if="step2" class="step2">
        ...
        <div class="btn-swipe" style="color: white; position: absolute; bottom: calc(env(safe-area-inset-bottom) + 30px); text-align: center; width: calc(100vw - 30px); line-height: 1.41176; letter-spacing: -0.025em;">S'inscrire</div>
      </div>
    </div>
  </main>
</template>
