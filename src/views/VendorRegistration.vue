<template>
  <main style="padding: 0px 15px 15px;">
    <div class="checkout__header">
      ...
      <div v-if="step1" class="checkout__title">Informations</div>
      <div v-else-if="step2" class="checkout__title">Informations</div>
      <div v-else-if="step3" class="checkout__title">Félicitation</div>
      <div v-else class="checkout__title">Inscription vendeur</div>
    </div>
    ...
    <div class="checkout__body" style="overflow: scroll; padding-bottom: 50px; padding-top: 15px;">
      ...
      <div v-if="type" class="step1">
        ...
        <div style="display: flex; justify-content: space-between;">
          <div @click="goStep1('company')" style="width: 48%; text-align: center; padding: 30px 20px; border-radius: 16px; border: 2px solid #ff2a80;">
          ...
          <div @click="goStep1('individual')" style="width: 48%; text-align: center; padding: 30px 20px; border-radius: 16px; border: 2px solid #ff2a80;">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" style="width: -webkit-fill-available; height: 32px; margin-bottom: 15px;">
              <path d="M352 128A128 128 0 1 1 224 0a128 128 0 0 1 128 128z" class="fa-secondary" style="fill: #ff2a80;"></path>
