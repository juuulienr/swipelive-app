        ...
        <div v-if="clip.vendor" class="video-page__influencer-badge2" :style="{'top': safeareaTop }" style="padding-right: 9px; left: 50px;">
          ...
          <div>
	          <svg v-if="!following[index].value" @click="follow(clip.vendor.user.id)" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" style="width: 28px; height: 28px;">
	            <path style="fill: #ff2a80;" d="M352 280H280V352c0 13.2-10.8 24-23.1 24C242.8 376 232 365.2 232 352V280H160C146.8 280 136 269.2 136 256c0-13.2 10.8-24 24-24H232V160c0-13.2 10.8-24 24-24C269.2 136 280 146.8 280 160v72h72C365.2 232 376 242.8 376 256C376 269.2 365.2 280 352 280z"/>
