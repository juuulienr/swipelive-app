<template>
  <main class="my_profile1">
    <div class="checkout__header" style="padding: 15px;position: fixed;top: 0px;z-index: 10000000;background: white;width: 100%;">
      <div @click="goBack()" class="checkout__close-btn" style="left: initial; top: 8px; padding: 0.5rem 0px;">
      ...
      <div @click="submit()" class="checkout__right-btn" style="right: 15px; top: 9px;">
        <div style="color: #ff2773; font-weight: 500;">Enregistrer</div>
      </div>
    </div>

    <div class="checkout__body" style="overflow: scroll; padding: 15px; margin-top: 50px; margin-bottom: 40px;">
      <div>
