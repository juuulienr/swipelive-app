    ...
    <div class="checkout">
      <div class="checkout__header" style="padding: 15px;">
        ...
        <div class="checkout__right-btn" style="position: absolute; right: 15px; top: 8px; padding: 0.5rem 0px;">
          <div @click="deleteProduct(product.id)" style="color: #FE2C55; font-weight: 600;">Supprimer</div>
        </div>
      </div>
      ...
      <!-- popup variant -->
      <div v-if="popupVariant" class="store-products-item__login-popup store-products-item__login-popup--active" style="overflow-y: scroll; height: 100%; box-shadow: rgba(0, 0, 0, 1) 0px 10px 5px 0px;"> 
      ...
      <!-- edit variant -->
      <div v-if="popupEditVariant" class="store-products-item__login-popup store-products-item__login-popup--active" style="overflow-y: scroll; height: 100%; box-shadow: rgba(0, 0, 0, 1) 0px 10px 5px 0px;"> 
        <div class="checkout__header">
