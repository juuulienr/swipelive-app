<template>
  <main class="products">
    ...
    <!-- promo popup -->
    <div class="store-products-item__login-popup store-products-item__login-popup--active" v-if="popupPromo" style="overflow-y: scroll; height: 40%; padding: 15px; box-shadow: rgba(0, 0, 0, 1) 0px 10px 5px 0px;"> 
