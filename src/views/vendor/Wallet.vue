<template>
  <main class="products">
    <div class="checkout">
      ...
      <!-- history -->
      <div class="store-products-item__login-popup store-products-item__login-popup--active" v-if="popupHistory" style="overflow-y: scroll; height: 100%; box-shadow: rgba(0, 0, 0, 1) 0px 10px 5px 0px;"> 
        <div class="checkout__header" style="padding: 15px;">
