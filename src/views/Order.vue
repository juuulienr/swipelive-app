            ...
            <div class="css-ikzlcq">
              ...
              <div class="css-9jay18">
                ...
                <div class="MuiBox-root css-s2uf1z">
                	...
                	<h6 v-if="user.id == order.buyer.id" class="MuiTypography-root MuiTypography-subtitle1 css-kdhaao" style="font-weight: 600;">{{ order.total | formatPrice }}€</h6>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="MuiPaper-root MuiPaper-elevation MuiPaper-rounded MuiPaper-elevation0 MuiCard-root css-1h7d8f3" style="border: 1px solid rgba(22, 24, 35, 0.12); padding: 5px 10px; margin-top: 15px; border-radius: 15px;">
          <div class="MuiCardHeader-root css-15x3obx">
            <div class="MuiCardHeader-content css-11qjisw">
              <span class="MuiTypography-root MuiTypography-h6 MuiCardHeader-title css-jef1j">Suivre le colis</span>
              <span v-if="order.trackingNumber" class="MuiTypography-root MuiTypography-h6 MuiCardHeader-title css-jef1j" style="float: right;font-size: 13px;font-weight: 500;color: hsl(240deg 5% 72%);margin-top: 3px;">N°{{ order.trackingNumber }}</span>
            </div>
          </div>
          <div class="MuiCardContent-root css-18mhetb">
            <ul class="MuiTimeline-root MuiTimeline-positionRight css-1oa1nt">
              <li class="MuiTimelineItem-root MuiTimelineItem-positionRight MuiTimelineItem-missingOppositeContent css-1rcbby2">
                ...
                <div class="MuiTypography-root MuiTypography-body1 MuiTimelineContent-root MuiTimelineContent-positionRight css-hg5jyh">
                  <h6 class="MuiTypography-root MuiTypography-subtitle2 css-yemnbq">Commande reçu</h6>
                  <span class="MuiTypography-root MuiTypography-caption css-6f545k">{{ order.createdAt }}</span>
                </div>
              </li>
              <li class="MuiTimelineItem-root MuiTimelineItem-positionRight MuiTimelineItem-missingOppositeContent css-1rcbby2">
                <div class="MuiTimelineSeparator-root css-11tgw8h">
              ...
              <li class="MuiTimelineItem-root MuiTimelineItem-positionRight MuiTimelineItem-missingOppositeContent css-1rcbby2">
                <div class="MuiTimelineSeparator-root css-11tgw8h">
                	<span class="MuiTimelineDot-root MuiTimelineDot-filled MuiTimelineDot-filledWarning css-1f06y3t"></span>
                	<span class="MuiTimelineConnector-root css-fz3k0c"></span>
                </div>
                <div class="MuiTypography-root MuiTypography-body1 MuiTimelineContent-root MuiTimelineContent-positionRight css-hg5jyh">
              ...
              <li class="MuiTimelineItem-root MuiTimelineItem-positionRight MuiTimelineItem-missingOppositeContent css-1rcbby2">
                <div class="MuiTimelineSeparator-root css-11tgw8h">
                	<span class="MuiTimelineDot-root MuiTimelineDot-filled MuiTimelineDot-filledError css-1f06y3t"></span>
                </div>
                <div class="MuiTypography-root MuiTypography-body1 MuiTimelineContent-root MuiTimelineContent-positionRight css-hg5jyh">
