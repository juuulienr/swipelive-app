  ...
  <main class="products">
    <div class="checkout">
      ...
      <div v-if="order" class="checkout__body">
        ...
        <div class="MuiPaper-root MuiPaper-elevation MuiPaper-rounded MuiPaper-elevation0 MuiCard-root css-1h7d8f3" style="border: 1px solid rgba(22, 24, 35, 0.12); padding: 5px 10px; margin-top: 15px; border-radius: 15px;">
          ...
          <div class="MuiCardContent-root css-18mhetb">
            <ul class="MuiTimeline-root MuiTimeline-positionRight css-1oa1nt">
              ...
              <li class="MuiTimelineItem-root MuiTimelineItem-positionRight MuiTimelineItem-missingOppositeContent css-1rcbby2">
                <div class="MuiTimelineSeparator-root css-11tgw8h"><span class="MuiTimelineDot-root MuiTimelineDot-filled MuiTimelineDot-filledInfo css-1f06y3t"></span><span class="MuiTimelineConnector-root css-fz3k0c"></span></div>
                <div class="MuiTypography-root MuiTypography-body1 MuiTimelineContent-root MuiTimelineContent-positionRight css-hg5jyh">
                  <h6 class="MuiTypography-root MuiTypography-subtitle2 css-yemnbq" style="color: hsl(240deg 5% 72%); font-weight: 500;">Colis déposé</h6>
                  <span class="MuiTypography-root MuiTypography-caption css-6f545k" style="color: hsl(240deg 5% 72%);">24 Mar 2022 1:46 PM</span>
                </div>
              </li>
              <li class="MuiTimelineItem-root MuiTimelineItem-positionRight MuiTimelineItem-missingOppositeContent css-1rcbby2">
                <div class="MuiTimelineSeparator-root css-11tgw8h"><span class="MuiTimelineDot-root MuiTimelineDot-filled MuiTimelineDot-filledWarning css-1f06y3t"></span><span class="MuiTimelineConnector-root css-fz3k0c"></span></div>
                <div class="MuiTypography-root MuiTypography-body1 MuiTimelineContent-root MuiTimelineContent-positionRight css-hg5jyh">
                  <h6 class="MuiTypography-root MuiTypography-subtitle2 css-yemnbq" style="color: hsl(240deg 5% 72%); font-weight: 500;">Colis en transit</h6>
                  <span class="MuiTypography-root MuiTypography-caption css-6f545k" style="color: hsl(240deg 5% 72%);">25 Mar 2022 1:46 PM</span>
                </div>
              </li>
              <li class="MuiTimelineItem-root MuiTimelineItem-positionRight MuiTimelineItem-missingOppositeContent css-1rcbby2">
                ...
                <div class="MuiTypography-root MuiTypography-body1 MuiTimelineContent-root MuiTimelineContent-positionRight css-hg5jyh">
                  <h6 class="MuiTypography-root MuiTypography-subtitle2 css-yemnbq" style="color: hsl(240deg 5% 72%); font-weight: 500;">Colis disponible en point relais/Colis livré</h6>
                  <span class="MuiTypography-root MuiTypography-caption css-6f545k" style="color: hsl(240deg 5% 72%);">26 Mar 2022 1:46 PM</span>
                </div>
              </li>
              <li class="MuiTimelineItem-root MuiTimelineItem-positionRight MuiTimelineItem-missingOppositeContent css-1rcbby2">
                <div class="MuiTimelineSeparator-root css-11tgw8h"><span class="MuiTimelineDot-root MuiTimelineDot-filled MuiTimelineDot-filledError css-1f06y3t"></span></div>
...
.products .one_item .title {
  font-size: 0.9em;
  font-weight: 500;
  margin-bottom: 6px;
}

.products .one_item .desc {
  font-size: 0.85em;
  color: #6c7b8a;
  margin-bottom: 0px;
}

.products .one_item .price {
  margin-right: 5vw;
  color: #5882f2;
  position: relative;
  top: 1px;
...
.box .completed, .box .closed, .box .progress {
    font-size: 12px;
    color: #FFFFFF;
    font-weight: 600;
    padding: 4px 10px;
...
.address__header {
  position: relative;
  padding: .9rem 0;
  border-bottom: 1px solid rgba(58, 58, 58, .2);
...
.address__popup-body {
  padding: 0 1rem 1rem;
  box-shadow: 0 0 8px 0 rgba(58, 58, 58, .2);
  border-radius: .25rem;
  background-color: #fff;
...
.address__state-item:hover {
  background-color: rgba(58, 58, 58, .2)
}

.address__state-list-container {
  position: absolute;
  left: 0;
  top: 0;
  right: 0;
...
.address__state-list-container ul {
  padding-left: 0;
  margin: 0;
  overflow-x: auto;
...
.address__state-field {
  position: relative
}

.address__state-field .address__state-overlay {
  position: absolute;
  left: 0;
  top: 0;
  width: 100%;
...
.address__state-list-search-field .text-input__input {
  border: none;
...
.checkout__overlay .default-spinner {
  width: 5rem
}

.checkout__plus-minus {
  text-align: center
}
...
.checkout__plus-minus-btn .default-button__text {
  margin-bottom: 5px
}
...
.checkout__link .default-button__text {
  display: flex;
  justify-content: space-between
}

.checkout__link .checkout__link-text {
  color: #999;
  font-size: .9rem;
  font-weight: 500;
}

.checkout__link .checkout__link-text span {
  line-height: normal;
  font-size: 1.5rem
}

.checkout__link .icon--back {
...
.checkout__product-info-row.checkout__row {
  border-bottom: 0
}
...
.checkout__product-info .checkout__image {
  width: 64px;
  height: 64px;
  margin-right: 1.2rem;
}

.checkout__product-info .checkout__image2 {
  width: 48px;
  height: 48px;
  margin-right: 0.8rem;
}
...
.checkout__price-body {
  margin-top: 1rem
}

.checkout__link-text-active {
  display: flex;
  align-items: center
}

.checkout__link-text-active-btn {
  width: 100%;
  display: flex;
  justify-content: space-between;
...
.checkout__link-text-active-btn .icon--back {
  transform: rotate(180deg)
}

.checkout__link-text-item {
  padding: 0 .5rem;
  color: rgba(58, 58, 58, .5)
}

.checkout__link-text-item:first-child {
  font-weight: 700;
  min-width: 100px
}

.checkout__link-text-item-red {
  color: #ea573c
}

.checkout__link-text-item-blue {
  color: #46b1cd
}
...
.checkout__btn-google .gpay-card-info-animation-container {
  left: 0;
  padding-right: .6em;
  padding-left: .6em;
  border-radius: 10rem
...
.checkout__btn-google .gpay-button.buy,
.checkout__btn-google .gpay-card-info-container.buy {
  width: 100%;
  max-width: none;
  height: 50px;
  padding-right: .6em;
...
.checkout__btn-google.checkout__btn-google__active {
  display: block
}

.checkout__btn-google.checkout__btn-google__disabled {
  pointer-events: none
}

.checkout__btn-google.checkout__btn-google__disabled .gpay-button.buy {
  background-color: #939393
}

.checkout__btn-apple-holder {
  display: none;
  margin-top: 1rem
}

.checkout__btn-apple-holder.checkout__btn-apple-holder__active {
  display: block
}

.checkout__payment-tabs-holder {
  display: flex;
  flex-wrap: wrap;
  margin-right: -3px;
  margin-left: -3px;
...
.checkout__payment-tab .icon {
  font-size: 3rem
}

.checkout__payment-tab .checkout__payment-tab-inner {
...
.checkout__payment-tab .checkout__payment-tab-inner.checkout__payment-tab-inner--active {
  background-color: #fff;
  border-bottom: 0;
  position: relative;
  top: 1px
...
.checkout__payment-tab .checkout__payment-tab-inner:not(.checkout__payment-tab-inner--cc) .icon {
  font-size: 3rem;
  height: 80%
}

.checkout__payment-tab .checkout__payment-tab-inner.checkout__payment-tab-inner--cc {
  font-weight: 700
}

.checkout__payment-tab .checkout__payment-tab-inner.checkout__payment-tab-inner--cc .icon {
  display: block;
  margin-bottom: .4rem;
  font-size: 1rem;
  width: 100%
...
.login-contents__header {
  position: relative
}

.login-contents__back {
  display: flex;
  align-items: center;
  position: absolute;
  left: 0;
...
@media (max-width:991.98px) {
  ...
  .login__content-enter-active .login-contents__back,
  .login__content-leave-active .login-contents__back {
    display: none
  }
}

.login-contents__headline {
  font-weight: 600;
  margin-bottom: 1em;
  line-height: 1.7
}

.create-screen-name__line {
  display: flex;
  margin-bottom: 1.25em
}

.create-screen-name__input {
  flex: 1
}

.create-screen-name__agree {
  display: flex;
  align-items: center;
  margin: 2em 1.5em;
  text-align: left
...
.create-screen-name__agree input {
  margin-right: 1em
}

.create-screen-name__agree a {
  color: #46b1cd;
  text-decoration: none
}

.create-screen-name__agree a:hover {
  text-decoration: underline
}

.create-screen-name__button-holder {
  display: flex;
  justify-content: space-between
}

.create-screen-name__button-holder .default-button {
  width: 50%
}

.create-screen-name__button-holder .default-button.create-screen-name__button {
  width: 49%
}
...
.css-1t2syce .MuiOutlinedInput-notchedOutline {
...
export default {
  ...
  methods: {
    actionSheet() {
      var options = {
        buttonLabels: ['Envoyer un message', 'Contester la commande'],
